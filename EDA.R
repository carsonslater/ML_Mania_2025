...
all_team_ids <- read_csv(here::here("Data/MMasseyOrdinals_thruSeason2024_day128.csv")) |> 
...
rankings <-
  expand_grid(Season = 2003:2024, RankingDayNum = 1:154, TeamID = all_team_ids, SystemName = unique(r_of_interest$SystemName)) |> 
  left_join(
    r_of_interest 
  ) |> 
...
# ranking_data <- 
#   read_csv("Data/ranking_data_2.csv", guess_max = 10000) |> 
#   relocate(TeamID) |> 
#   janitor::clean_names() |>
